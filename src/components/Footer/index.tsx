    ...
    return (
        <footer className='border-t-4 text-[#E3E3E3] border-[#000000] bg-[#000000]'>
            <div className="container w-full mx-auto">
                ...
                <div className="hidden md:flex flex-col mt-8 xl:mt-14">
                    <div className="flex justify-between mb-8 2xl:mb-[20px]">
                        ...
                        <div>
                            ...
                            <p className="w-[190px]">K. C. Mahindra Education Trust Cecil Court, Near Regal Cinema, Mahakavi Bhushan Marg, Mumbai 400001.</p>
                        </div>
                ...
                {/* Mobile View */}
                <div className="flex md:hidden flex-col mt-5 p-5 bg-[#000000]">
                    {/* Company Logo */}
                    ...
                    <div className="flex flex-col space-y-4">
                        <div>
                            <strong className='uppercase font-semibold text-sm mb-2 block'>COMPANY</strong>
                            <ul className="space-y-2">
                                <li className="cursor-pointer">Home</li>
                                <li className="cursor-pointer">About Us</li>
                                <li className="cursor-pointer">Resume Builder</li>
                        ...
                        <div>
                            <strong className='uppercase font-semibold text-sm mb-2 block'>LEGAL</strong>
                            <ul className="space-y-2">
                                <li className="cursor-pointer">Privacy Policy</li>
                                <li className="cursor-pointer">Terms of Use</li>
                                <li className="cursor-pointer">Cookie Policy</li>
                        ...
                        <div>
                            <strong className='uppercase font-semibold text-sm mb-2 block'>RESOURCES</strong>
                            <ul className="space-y-2">
                                <li className="cursor-pointer">Help Center</li>
                                <li className="cursor-pointer">FAQs</li>
                            </ul>
                        ...
                        <div>
                            <strong className='uppercase font-semibold text-sm mb-2 block'>CONTACT US</strong>
                            <p className="w-full text-sm">K. C. Mahindra Education Trust Cecil Court, Near Regal Cinema, Mahakavi Bhushan Marg, Mumbai 400001.</p>
                        </div>
                    </div>
                    ...
                    {/* Copyright */}
                    <div className="text-center text-xs mt-4 border-t border-[#BDBDBD] pt-4">
